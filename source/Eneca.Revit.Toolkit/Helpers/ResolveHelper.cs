...
public static class ResolveHelper
{
	...
	///     this requires calling <see cref="EndAssemblyResolve" /> immediately after executing user code where dependency
	///     failures occur.
	/// </remarks>
	...
	public static void BeginAssemblyResolve(Type type)
	{
        ...
        var resolversField =
 loadContextType.GetField("AssemblyResolve", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly)!;
		...
		var resolversField = domainType.GetField("_AssemblyResolve",
