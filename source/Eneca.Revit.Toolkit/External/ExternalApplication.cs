...
/// <summary>
///     Class that supports addition of external applications to Revit. Is the entry point when loading an external
///     application.
/// </summary>
/// <remarks>
...
public abstract class ExternalApplication : IExternalApplication
{
	...
	/// </summary>
	/// <remarks>
	///     Method <see cref="OnShutdown()" /> will not be executed if the value of this property is different from
	///     <see cref="Autodesk.Revit.UI.Result.Succeeded" />.
	/// </remarks>
	public Result Result { get; set; } = Result.Succeeded;

	/// <summary>
	///     Reference to the <see cref="Autodesk.Revit.UI.UIControlledApplication" /> that is needed by an external
	///     application.
	/// </summary>
	...
	/// </summary>
	/// <remarks>
	///     The method will not be executed if the value of the <see cref="Result" /> property in the
	///     <see cref="OnStartup()" />
