...
public abstract class ExternalCommand : IExternalCommand
{
	...
	/// <summary>
	///     Element set indicating problem elements to display in the failure dialog. This will be used only if the command
	///     status was "Failed".
	/// </summary>
	...
	/// <summary>
	///     Error message can be returned by external command. This will be displayed only if the command status was "Failed"
	///     <br />
	...
	{
		Context.SuppressDialogs(result);
	}
	...
	{
		Context.SuppressDialogs(handler);
	}
