...
/// </summary>
[PublicAPI]
public class DockablePaneProvider : IDockablePaneProvider, IDockablePaneProviderId, IDockablePaneProviderTitle,
	IDockablePaneProviderConfiguration
{
	...
	public static IDockablePaneProviderConfiguration Register(UIControlledApplication application, Guid id,
		string title)
	{
		return new DockablePaneProvider
		{
	...
	/// <param name="id">Unique identifier for the new pane.</param>
	/// <param name="title">String to use for the pane caption.</param>
	public static IDockablePaneProviderConfiguration Register(UIControlledApplication application, DockablePaneId id,
		string title)
	{
		return new DockablePaneProvider
		{
...
/// <summary>
///     Interface that the Revit UI will call during initialization of the user interface to gather information about
///     add-in dockable pane windows.
/// </summary>
[PublicAPI]
public interface IDockablePaneProviderConfiguration
{
	...
	///     Optionally, providers can set the ContextualHelp property if they wish to provide or react to help requests on the
	///     pane,
