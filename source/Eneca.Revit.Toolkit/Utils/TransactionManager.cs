...
public static class TransactionManager
{
	...
	/// <remarks>
	///     The transaction name has already been declared in the implementation, to override, use the
	///     <see cref="ITransactionSettings.SetName" /> method
	/// </remarks>
	...
	[Pure]
	public static ITransaction Modify(this Document document,
		[InstantHandle] Func<IDocumentTransactionSettings, ITransactionSettings> settings)
	{
	...
	public static ISubTransaction Modify(this Document document,
		[InstantHandle] Func<IDocumentTransactionSettings, ISubTransactionSettings> settings)
	{
	...
	/// <remarks>
	///     The group transaction name has already been declared in the implementation, to override, use the
	///     <see cref="IGroupTransactionSettings.SetName" /> method
	/// </remarks>
	/// <returns>New <see cref="IGroupTransaction" /> object</returns>
	[Pure]
	public static IGroupTransaction Modify(this Document document,
		[InstantHandle] Func<IDocumentTransactionSettings, IGroupTransactionSettings> settings)
	{
		var transactionSettings = settings.Invoke(new DocumentTransactionSettings());
...
public interface ITransactionSettings
{
	...
	/// <summary>
	///     Delay the display of the mini-warning dialog (if one is to be shown as a result of warnings in the current
	///     transaction) until the end of the next transaction
	/// </summary>
	/// <remarks>
...
public interface IGroupTransactionSettings
{
	...
	/// <summary>
	///     Forces all transactions finished inside this group to disable modal failure handling regardless of what failure
	///     handling options are set for those transactions
	/// </summary>
...
public interface IGroupTransaction
{
	...
	/// <remarks>
	///     <p>
	///         Committing a group does not change the model. It only confirms the commitment of all inner groups and
	///         transactions
	///     </p>
	///     <p>
