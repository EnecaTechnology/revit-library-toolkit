...
{
	/// <summary>
	///     Automatically processes failure messages during transaction flow by resolving or deleting them, eliminating the
	///     need for manual intervention.
	/// </summary>
	/// <param name="failuresAccessor">An object that provides access to the failure messages and their handling options.</param>
	/// <returns>
	///     Returns <see cref="FailureProcessingResult.ProceedWithCommit" /> if all failures are resolved or deleted, otherwise
	///     returns <see cref="FailureProcessingResult.ProceedWithRollBack" />.
	/// </returns>
	/// <remarks>
	...
	/// <summary>
	///     Automatically processes failure messages during transaction flow by cancelling all them, eliminating the need for
	///     manual intervention.
	/// </summary>
	/// <param name="failuresAccessor">An object that provides access to the failure messages and their handling options.</param>
	/// <returns>
