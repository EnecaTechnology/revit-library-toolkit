...
/// <summary>
///     A class for custom handlers of duplicate type names encountered during a paste operation. When the destination
///     document
///     contains types that have the same names as the types being copied, but different internals, a decision must be made
///     on how to proceed - whether to
...
public class DuplicateTypeNamesHandler : IDuplicateTypeNamesHandler
{
	...
	/// </summary>
	/// <param name="action">
	///     A structure that provides information about an attempt to copy types with names that already exist
	...
	///     Encapsulates a method on a structure that provides information about an attempt to copy types with names that
