...
public class SelectionConfiguration
{
	...
	private class SelectionFilterInternal(SelectionConfiguration selectionConfiguration)
		: ISelectionFilter, ISelectionFilterConfiguration
	{
...
public interface ISelectionFilterConfiguration
{
	...
	/// </param>
	/// <returns>
	///     Return true to allow the user to select this candidate element. Return false to prevent selection of this
	///     element.
	/// </returns>
	/// <remarks>
	///     If prompting the user to select an element from a Revit Link instance, the element passed here will be the link
	///     instance, not the selected linked element.<br />
	...
	/// </param>
	/// <returns>
	///     Return true to allow the user to select this candidate reference. Return false to prevent selection of this
	///     candidate.<br />
	///     If an exception is thrown from this method, the element will not be permitted to be selected.
	/// </returns>
	public SelectionConfiguration Reference(Func<Reference, XYZ, bool> referenceHandler);
