...
/// <summary>
///     Callback that may be used to control Revit when trying to unload or reload a Revit link with changes in shared
///     coordinates.
/// </summary>
[PublicAPI]
public class SaveSharedCoordinatesCallback : ISaveSharedCoordinatesCallback
{
	...
	/// </summary>
	/// <param name="options">
	///     The options when saving a linked file which has been modified in-memory by shared coordinates
	///     operations.
	/// </param>
	...
	/// </summary>
	/// <param name="handler">
	///     Encapsulates a method for options when saving a linked file which has been modified in-memory by
